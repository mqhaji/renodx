...
// ---- Created with 3Dmigoto v1.4.1 on Wed Jan  8 23:24:42 2025
...
void main(
  ...
  r0.xyz = r0.xyw * bloomScale.xyz * injectedData.fxBloom + r1.xyz;  // scale bloom
  ...
  float3 untonemapped = r0.rgb;  // identical to tonemap1_0xE455F507 after this point
