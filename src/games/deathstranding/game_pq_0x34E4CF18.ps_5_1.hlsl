...
void main(PSInput input, out float4 SV_TARGET : SV_TARGET)
{
    ...
    if (r0.x != 0) {    // if_nz r0.x
        ...
        r3.xyz = r1.xyzx * float4(0.333333343, 0.333333343, 0.333333343, 4.306667);    // mul r3.xyzw, r1.xyzx, l(0.333333343, 0.333333343, 0.333333343, 4.306667)
    ...
    if (r2.y != 0) {    // if_nz r2.y
        ...
        r3.xyz = (r2.xywx < float3(0.003100, 0.003100, 0.003100)) ? float3(1.0, 1.0, 1.0) : float3(0.0, 0.0, 0.0);    //         lt r3.xyz, r2.xywx, l(0.003100, 0.003100, 0.003100, 0.000000)
        ...
        if (r2.z != 0) {    // if_nz r2.z
            ...
            r1.xyz = renodx::color::pq::from::BT2020((r0.xyz * injectedData.toneMapGameNits) / 10000.f);
        }
    }
