...
void frag_main()
{
    ...
    for (;;)
    {
        float4 _102 = _8.Sample(_24[asuint(_15_m0[0u]).w + 0u], float2((_20_m0[71u].x * _37[_83]) + TEXCOORD.x, TEXCOORD.y));
        float4 _131 = _8.Sample(_24[asuint(_15_m0[0u]).w + 0u], float2(TEXCOORD.x - (_20_m0[71u].x * _37[_83]), TEXCOORD.y));
