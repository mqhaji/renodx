...
void frag_main()
{
    ...
    float _121 = (((_20_m0[35u].w - _20_m0[35u].z) * 2.0f) * ((_20_m0[35u].y > 0.0f) ? abs(TEXCOORD.y + (-0.5f)) : abs(TEXCOORD.x + (-0.5f)))) + _20_m0[35u].z;
    float _122 = _121 * _121;
    SV_Target.x = (_20_m0[40u].x * _42) * _122;
    SV_Target.y = (_20_m0[40u].y * _44) * _122;
    SV_Target.z = (_20_m0[40u].z * _46) * _122;
    SV_Target.w = 1.0f;
}
