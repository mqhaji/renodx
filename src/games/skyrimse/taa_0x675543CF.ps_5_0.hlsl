  ...
  out float4 o1 : SV_Target1)
{
  ...
  r6.yxz = convertRenderInput(r6.yxz);  // HDR input conversion
  ...
  r11.yxz = convertRenderInput(r11.yxz);  // HDR input conversion

  r11.w = dot(r11.xzy, float3(0.5,0.25,0.25));
  r9.x = cmp(r11.w < r2.x);

  r12.xyz = t0.Sample(s0_s, r8.xy).yxz;
  r12.yxz = convertRenderInput(r12.yxz);  // HDR input conversion
