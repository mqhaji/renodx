#ifndef SRC_METAL_GEAR_RISING_REVENGEANCE_SHARED_H_
#define SRC_METAL_GEAR_RISING_REVENGEANCE_SHARED_H_

#define ENABLE_HDR 0u
...
struct ShaderInjectData {
  ...
  float color_grade_fix_lut_sampling;
  float graphics_white_scale;
  float padding3;
};
...
#define CUSTOM_GRAIN_TYPE                    shader_injection[3][3]
...
#define RENODX_COLOR_GRADE_FIX_LUT_SAMPLING  shader_injection[5][1]
#define RENODX_GRAPHICS_WHITE_SCALE          shader_injection[5][2]
...
#define RENODX_COLOR_GRADE_FIX_LUT_SAMPLING  shader_injection.color_grade_fix_lut_sampling
#define RENODX_GRAPHICS_WHITE_SCALE          shader_injection.graphics_white_scale
...
#endif  // SRC_METAL_GEAR_RISING_REVENGEANCE_SHARED_H_
