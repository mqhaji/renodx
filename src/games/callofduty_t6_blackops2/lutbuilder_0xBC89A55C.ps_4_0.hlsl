...
// ---- Created with 3Dmigoto v1.4.1 on Sat Oct 18 15:11:02 2025
...
SamplerState baseLut2DSampler_s : register(s0);
...
void main(
  ...
  r0.xyzw = baseLut2DSampler.Sample(baseLut2DSampler_s, v1.xz).xyzw;
  r0.xyzw = postFxControlE.yyyy * r0.xyzw;
  r1.xyzw = baseLut2DSampler.Sample(baseLut2DSampler_s, v1.xy).xyzw;
  r0.xyzw = r1.xyzw * postFxControlE.xxxx + r0.xyzw;
  r1.x = dot(r0.xyz, float3(0.212585449, 0.715194702, 0.0722198486));
  r1.xyzw = saturate(r1.xxxx * postFxControl0.xzyw + postFxControl1.xzyw);
  ...
  r1.w = dot(r1.xzy, float3(1, 1, 1));
  r1.w = 1 / r1.w;
  r1.xyz = r1.xyz * r1.www;
  r2.xyz = r0.xyz * r0.xyz;
  r2.w = r0.w;
  r3.x = dot(r2.xyzw, postFxControl2.xyzw);
  r3.y = dot(r2.xyzw, postFxControl3.xyzw);
  r3.z = dot(r2.xyzw, postFxControl4.xyzw);
  r0.w = saturate(dot(r3.xyz, r1.xyz));
  r3.x = log2(r0.w);
  r4.x = dot(r2.xyzw, postFxControl5.xyzw);
  r4.y = dot(r2.xyzw, postFxControl6.xyzw);
  r4.z = dot(r2.xyzw, postFxControl7.xyzw);
  r0.w = saturate(dot(r4.xyz, r1.xyz));
  r3.y = log2(r0.w);
  r4.x = dot(r2.xyzw, postFxControl8.xyzw);
  r4.y = dot(r2.xyzw, postFxControl9.xyzw);
  r4.z = dot(r2.xyzw, postFxControlA.xyzw);
  o0.w = r2.w;
  r0.w = saturate(dot(r4.xyz, r1.xyz));
  r3.z = log2(r0.w);
  r1.xyz = postFxControlB.xyz * r3.xyz;
  r1.xyz = exp2(r1.xyz);
  r0.w = dot(r1.xyz, postFxControlC.xyz);
  r1.xyz = r1.xyz + -r0.www;
  r1.xyz = postFxControlC.www * r1.xyz + r0.www;
  r0.xyz = -r0.xyz * r0.xyz + r1.xyz;
  r0.xyz = postFxControlD.xyz * r0.xyz + r2.xyz;
  r0.w = 1;
  r1.x = saturate(dot(r0.xyzw, colorMatrixR.xyzw));
  o0.x = sqrt(r1.x);
  r1.x = saturate(dot(r0.xyzw, colorMatrixG.xyzw));
  r0.x = saturate(dot(r0.xyzw, colorMatrixB.xyzw));
  o0.z = sqrt(r0.x);
  o0.y = sqrt(r1.x);
  return;
}
