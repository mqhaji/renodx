...
#include <embed/0x479EA19A.h>    // Tonemap
#include <embed/0xFEEFE4E6.h>    // Grain?
...
extern "C" __declspec(dllexport) const char* NAME = "RenoDX - Dark Souls III";
extern "C" __declspec(dllexport) const char* DESCRIPTION = "RenoDX for Dark Souls III";

ShaderReplaceMod::CustomShaders customShaders = {

  // CustomSwapchainSahder(0xF87B3349),
  CustomShaderEntry(0x479EA19A),          //  Tonemap
  CustomShaderEntry(0xFEEFE4E6),          //  Grain?
