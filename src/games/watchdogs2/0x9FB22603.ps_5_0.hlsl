  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.z = Primitive__DiffuseSampler0__TexObj__.Sample(Video_s, r1.zw).w;
  r0.w = Primitive__DiffuseSampler0__TexObj__.Sample(Video_s, r1.xy).w;
  r1.xyz = float3(0,-0.391448975,2.01782227) * r0.zzz;
  r1.xyz = r0.www * float3(1.59579468,-0.813476563,0) + r1.xyz;
  r2.xy = r0.xy * VideoTextureUnpack[0].xy + VideoTextureUnpack[0].zw;
  r2.zw = r0.xy * VideoTextureUnpack[1].xy + VideoTextureUnpack[1].zw;
  r0.xyzw = max(VideoTextureUnpack[4].xyzw, r2.xyzw);
  r0.xyzw = min(VideoTextureUnpack[5].xyzw, r0.xyzw);
  r0.x = Primitive__DiffuseSampler0__TexObj__.Sample(Video_s, r0.xy).w;
  r2.w = Primitive__DiffuseSampler0__TexObj__.Sample(Video_s, r0.zw).w;
  r0.xyz = r0.xxx * float3(1.16412354,1.16412354,1.16412354) + r1.xyz;
  r0.xyz = float3(-0.87065506,0.529705048,-1.08166885) + r0.xyz;
  r2.xyz = max(float3(0,0,0), r0.xyz);
  r0.xyzw = v0.xyzw * r2.xyzw;
