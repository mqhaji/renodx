...
// ---- Created with 3Dmigoto v1.3.16 on Sat Jun 01 18:49:18 2024
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xy = ddx_coarse(v1.xy);
  r1.zw = -r1.xy * Sharpness + v1.xy;
  r1.xy = r1.xy * Sharpness + v1.xy;
  r2.xyzw = Primitive__DiffuseSampler0__TexObj__.Sample(Primitive__DiffuseSampler0__SampObj___s, r1.xy).xyzw;
  r1.xyzw = Primitive__DiffuseSampler0__TexObj__.Sample(Primitive__DiffuseSampler0__SampObj___s, r1.zw).xyzw;
  r0.xyzw = r0.xyzw * float4(5,5,5,5) + -r1.xyzw;
