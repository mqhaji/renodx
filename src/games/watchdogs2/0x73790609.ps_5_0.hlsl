  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.x = Primitive__DiffuseSampler0__TexObj__.Sample(Primitive__DiffuseSampler0__SampObj___s, v1.xy).w;
  r0.y = 1 + -r0.x;
  r0.x = TextureIsOffscreenComposited ? r0.y : r0.x;
  r0.xyzw = v0.xyzw * r0.xxxx;
