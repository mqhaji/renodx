  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyzw = FireUiPrimitive__DiffuseSampler0__TexObj__.Sample(FireUiPrimitive__DiffuseSampler0__SampObj___s, v1.xy).xyzw;
  r1.xyzw = v0.xyzw * r0.xyzw;
  r2.x = dot(r1.xyz, float3(0.298999995,0.587000012,0.114));
  r0.xyz = v0.xyz * r0.xyz + -r2.xxx;
  r1.xyz = DesaturationFactor * r0.xyz + r2.xxx;
  r0.x = cmp(0 < r0.w);
