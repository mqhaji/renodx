...
///
/// Calculates the average luminance of of the scene based on 4 sampled points.
/// The luminance is calculated in BT.709 linear space.
///
/// @param tex - The scene texture.
/// @param sampler - The sampler state to use for texture sampling.
/// @return The average luminance based on 4 sampled points.
///
