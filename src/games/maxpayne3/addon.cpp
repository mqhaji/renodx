...
#include <embed/0xFBC327C8.h>   // MSAA & FXAA Very High
...
renodx::mods::shader::CustomShaders custom_shaders = {
        CustomShaderEntry(0x30842A90),  // MSAA & FXAA Off
        CustomShaderEntry(0x77C2B3A7),  // MSAA & FXAA Normal
        CustomShaderEntry(0x3FA8CBC3),  // MSAA & FXAA High
        CustomShaderEntry(0xFBC327C8),  // MSAA & FXAA Very High
...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        .key = "adaptiveTonemap",
        .binding = &shader_injection.adaptiveTonemap,
        .value_type = renodx::utils::settings::SettingValueType::BOOLEAN,
        .default_value = 1.f,
        .can_reset = false,
        .label = "Adaptive Tonemap",
        .section = "Tone Mapping",
        .tooltip = "Keeps average luminance from exceeding 75% of game brightness (has performance cost)",
    },
    new renodx::utils::settings::Setting{
        .key = "toneMapPeakNits",
...
void OnPresetOff() {
  ...
  renodx::utils::settings::UpdateSetting("adaptiveTonemap", 0.f);
...
extern "C" __declspec(dllexport) const char* description = "RenoDX for Max Payne 3";
