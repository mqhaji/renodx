...
cbuffer Fsr2PrepareConstants : register(b0) {
...
void main(uint3 dispatch_thread_id : SV_DispatchThreadID) {
  ...
  // MGSV supplies sRGB scene RGB here; FSR2 temporal math requires linear RGB.
  ...
  // FSR2 reprojects as current_uv + motion, while MGSV's native signal and
