  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.x = 0.4921875 * r1.x;
  r1.x = 0.50390625 + r1.x;
  r3.y = g_psMaterial.m_materials[3].y;
  r3.y = max(-0.197500005, r3.y);
  r3.y = 5.34962368 * r3.y;
  r3.z = -r3.y;
  r3.z = max(r3.y, r3.z);
  r4.w = min(1, r3.z);
  r5.x = max(1, r3.z);
  ...
  r4.w = -r3.y;
  r3.y = cmp(r3.y < r4.w);
  // ASM: and r3.y, r3.y, l(-1)
  // r3.y = r3.y ? -nan : 0;
  r3.y = -r3.y;
  r4.w = -r3.z;
  r3.y = r3.y ? r4.w : r3.z;
  r3.y = r3.y / 1.10000002;
  r3.y = 0.74000001 + r3.y;
  r3.y = 0.5 * r3.y;
  r3.y = 0.96875 * r3.y;
  r3.y = 0.015625 + r3.y;
  r1.y = 1 + r1.y;
  ...
  r6.xyzw = inInscattering.Sample(g_samplerLinear_Clamp_s, r7.xy).xyzw;
  r6.xyzw = r6.xyzw * r1.xxxx;
  r7.xyzw = inInscattering.Sample(g_samplerLinear_Clamp_s, r8.xy).xyzw;
  r7.xyzw = r7.xyzw * r1.yyyy;
  r6.xyzw = r7.xyzw + r6.xyzw;
  r7.xyzw = -r5.xyzw;
  r6.xyzw = r7.xyzw + r6.xyzw;
  r6.xyzw = float4(0.519895613,0.519895613,0.519895613,0.519895613) * r6.xyzw;
  r5.xyzw = r6.xyzw + r5.xyzw;
  r5.xyzw = r5.xyzw;
  r5.xyzw = r5.xyzw;
