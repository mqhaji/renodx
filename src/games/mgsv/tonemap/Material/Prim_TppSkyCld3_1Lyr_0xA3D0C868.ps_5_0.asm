...
#line 269 "d:\work\master\git_clone\_intermediate\win64\TppShaders_dx11_win64\Release\Prim_TppSkyCld3_1Lyr_ps.hlsl"
...
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r2.xyxx, t0.xyzw, s10  // domeColor<0:Inf,1:Inf,2:Inf,3:Inf>
