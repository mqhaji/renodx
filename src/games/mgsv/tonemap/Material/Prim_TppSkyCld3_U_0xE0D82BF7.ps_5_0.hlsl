  ...
  out float4 o1 : SV_Target1)
{
  ...
  r3.xy = inDomeTexture.Sample(g_samplerLinear_Wrap_s, r3.xy).yw;
  r5.xyzw = r3.xxxy;
  r5.xyz = r5.xyz;
  r3.xyw = cmp(float3(0.0392800011,0.0392800011,0.0392800011) >= r5.xyz);
  r3.xyw = r3.xyw ? float3(1,1,1) : float3(0,0,0);
  r6.xyz = r5.xyz / float3(12.9200001,12.9200001,12.9200001);
  r6.xyz = r6.xyz * r3.xyw;
  r3.xyw = -r3.xyw;
  r3.xyw = float3(1,1,1) + r3.xyw;
  r7.xyz = float3(0.0549999997,0.0549999997,0.0549999997) + r5.xyz;
  r7.xyz = r7.xyz / float3(1.05499995,1.05499995,1.05499995);
  r7.xyz = max(float3(9.99999975e-06,9.99999975e-06,9.99999975e-06), r7.xyz);
  r7.xyz = log2(r7.xyz);
  r7.xyz = float3(2.4000001,2.4000001,2.4000001) * r7.xyz;
  r7.xyz = exp2(r7.xyz);
  r3.xyw = r7.xyz * r3.xyw;
  r5.xyz = r6.xyz + r3.xyw;
  r5.xyz = r5.xyz;
  ...
  r6.y = 0;
  r3.xy = r6.xy + r3.xy;
  r3.xy = inLowCylinderTexture.Sample(g_samplerLinear_Wrap_s, r3.xy).yw;
  r6.xyzw = r3.xxxy;
  r6.xyz = r6.xyz;
  r3.xyw = cmp(float3(0.0392800011,0.0392800011,0.0392800011) >= r6.xyz);
  r3.xyw = r3.xyw ? float3(1,1,1) : float3(0,0,0);
  r7.xyz = r6.xyz / float3(12.9200001,12.9200001,12.9200001);
  r7.xyz = r7.xyz * r3.xyw;
  r3.xyw = -r3.xyw;
  r3.xyw = float3(1,1,1) + r3.xyw;
  r8.xyz = float3(0.0549999997,0.0549999997,0.0549999997) + r6.xyz;
  r8.xyz = r8.xyz / float3(1.05499995,1.05499995,1.05499995);
  r8.xyz = max(float3(9.99999975e-06,9.99999975e-06,9.99999975e-06), r8.xyz);
  r8.xyz = log2(r8.xyz);
  r8.xyz = float3(2.4000001,2.4000001,2.4000001) * r8.xyz;
  r8.xyz = exp2(r8.xyz);
  r3.xyw = r8.xyz * r3.xyw;
  r6.xyz = r7.xyz + r3.xyw;
  r6.xyz = r6.xyz;
  r1.w = -r2.x;
  r1.w = 1 + r1.w;
  ...
  r3.y = 0;
  r2.xy = r3.xy + r2.yw;
  r2.xy = inMidCylinderTexture.Sample(g_samplerLinear_Wrap_s, r2.xy).yw;
  r2.xyzw = r2.xxxy;
  r2.xyz = r2.xyz;
  r3.xyw = cmp(float3(0.0392800011,0.0392800011,0.0392800011) >= r2.xyz);
  r3.xyw = r3.xyw ? float3(1,1,1) : float3(0,0,0);
  r6.xyz = r2.xyz / float3(12.9200001,12.9200001,12.9200001);
  r6.xyz = r6.xyz * r3.xyw;
  r3.xyw = -r3.xyw;
  r3.xyw = float3(1,1,1) + r3.xyw;
  r7.xyz = float3(0.0549999997,0.0549999997,0.0549999997) + r2.xyz;
  r7.xyz = r7.xyz / float3(1.05499995,1.05499995,1.05499995);
  r7.xyz = max(float3(9.99999975e-06,9.99999975e-06,9.99999975e-06), r7.xyz);
  r7.xyz = log2(r7.xyz);
  r7.xyz = float3(2.4000001,2.4000001,2.4000001) * r7.xyz;
