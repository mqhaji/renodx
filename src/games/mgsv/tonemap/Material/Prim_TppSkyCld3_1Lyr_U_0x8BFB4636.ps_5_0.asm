...
#line 269 "d:\work\master\git_clone\_intermediate\win64\TppShaders_dx11_win64\Release\Prim_TppSkyCld3_1Lyr_U_ps.hlsl"
...
#line 303
mov r1.w, v1.w  // NComputeCloudColor_computeCloudColor_inAttribute1<3>

#line 304
mov r2.xy, v2.zwzz  // NComputeCloudColor_computeCloudColor_inAttribute2<2,3>

#line 305
mov r2.zw, v3.xxxy  // NComputeCloudColor_computeCloudColor_inLightInfo<0,1>

#line 306
nop 
mov r1.xyz, r1.xyzx  // inColor<0,1,2>
mov r0.xyzw, r0.xyzw  // inFogColor<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf,3:NaN:Inf>
mov r1.w, r1.w  // inAttribute1<3>
mov r2.xy, r2.xyxx  // inAttribute2<2,3>
mov r2.zw, r2.zzzw  // inLightInfo<0,1>

#line 166
mov r2.xy, r2.xyxx  // inDomUV<0,1>

#line 167
mov r1.w, r1.w  // domeOpacity<0>

#line 169
add r2.xy, r2.xyxx, cb4[1].xyxx
sample_indexable(texture2d)(float,float,float,float) r2.xy, r2.xyxx, t0.ywxz, s10
mov r3.xyzw, r2.xxxy  // domeColor<0:Inf,1:Inf,2:Inf,3:Inf>

#line 174
nop 
mov r3.xyz, r3.xyzx  // inSRGB<0:Inf,1:Inf,2:Inf>

#line 48
ge r4.xyz, l(0.039280, 0.039280, 0.039280, 0.000000), r3.xyzx
movc r4.xyz, r4.xyzx, l(1.000000,1.000000,1.000000,0), l(0,0,0,0)  // mask<0:[-0f,1f],1:[-0f,1f],2:[-0f,1f]>

#line 49
div r5.xyz, r3.xyzx, l(12.920000, 12.920000, 12.920000, 0.000000)
...
add r3.xyz, r4.xyzx, r5.xyzx  // GammaDecode<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>

#line 174
mov r3.xyz, r3.xyzx  // domeColor<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>

#line 176
mul r3.xyzw, r1.wwww, r3.xyzw  // outColor<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf,3:NaN:Inf>

#line 212
mov r2.z, r2.z  // lightBlendRate<0>

#line 213
mov r4.xyz, cb4[4].xyzx
mul r4.xyz, r2.zzzz, r4.xyzx
mov r1.w, -r2.z
add r1.w, r1.w, l(1.000000)
mul r2.xyz, r1.wwww, r3.xyzx
add r2.xyz, r2.xyzx, r4.xyzx  // outColor<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>

#line 217
min r1.w, r3.w, l(1.000000)  // cloudAlpha<0:Inf:[-1.#INFf,1f]>

#line 218
mov r3.x, cb4[0].x  // luminance<0>
