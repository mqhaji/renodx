...
float3 psychotm_custom_test30(
  ...
  if (purity_scale != 1.f || highlight_saturation != 1.f || dechroma != 0.f) {
    ...
    if (dechroma != 0.f || highlight_saturation != 1.f) {
      ...
      float source_relative_yf = max(renodx::color::yf::from::LMS(source_lms / anchor_in_lms), 0.f);
  ...
  if (sdr_eotf_emulation != 0.f) {
    tonal_input_lms = renodx::color::correct::GammaSafe(tonal_input_lms / PSYCHO30_D65_WHITE_LMS) * PSYCHO30_D65_WHITE_LMS;
  }
