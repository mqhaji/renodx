  ...
  out float4 o0 : SV_Target0)
{
  ...
  r6.w = inFireTexture.Sample(g_samplerLinear_Wrap_s, r1.zw).x;
  r6.w = r6.w;
  r7.x = 0.150000006 * r6.w;
  r7.x = 1 + r7.x;
  r7.x = r7.x * r5.w;
  r7.x = r7.x * r7.y;
  r7.x = -r7.x;
  ...
  r1.z = r1.z;
  r1.z = r1.z * r1.z;
  r1.w = max(9.99999975e-05, r1.z);
  r1.w = log2(r1.w);
  r1.w = 18 * r1.w;
  r1.w = exp2(r1.w);
  r1.w = r1.z * r1.w;
  r4.w = 1.60000002 * r2.w;
  r4.w = -r4.w;
  r4.w = 1 + r4.w;
  r4.w = max(0, r4.w);
  r4.w = min(1, r4.w);
  ...
  r0.w = r0.w * r3.w;
  r0.w = r1.w * r0.w;
  r1.w = cmp(r0.w < 0.100000001);
  if (r1.w != 0) {
    if (-1 != 0) discard;
    r3.xyzw = float4(0,0,0,0);
  } else {
    r1.w = g_psMaterial.m_materials[7].y;
    r7.xzw = g_psMaterial.m_materials[1].xyz;
    r8.xyz = g_psMaterial.m_materials[2].xyz;
    ...
    r10.xyz = r4.xyz * r3.zzz;
    r3.xyz = r10.xyz + r3.xyw;
    ...
    r1.x = min(1, r1.x);
    r1.x = r1.z * r1.x;
    r1.xyz = float3(25,5,0.100000001) * r1.xxx;
    r0.xyz = r1.xyz + r0.xyz;
    r1.x = r6.w * r6.w;
    r1.xyz = float3(5,2.5,1) * r1.xxx;
    r2.w = 270 * r2.w;
    r2.w = -67.5 + r2.w;
    r2.w = max(0, r2.w);
    r2.w = min(1, r2.w);
