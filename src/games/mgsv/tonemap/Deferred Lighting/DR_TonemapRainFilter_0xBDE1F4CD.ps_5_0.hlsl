...
void main(
  ...
  r5.xyz = r5.xyz;
  r0.z = r0.z;
  // NCalculateRainColor_calcRainColor: screen-space rain position
  ...
  r3.xy = r3.xy;
  r3.zw = r3.zw;
  r2.zw = float2(9.99999975e-05, 9.99999975e-05) + r3.xy;
  r3.xy = -r0.ww;
  r2.zw = r3.xy + r2.zw;
  r2.zw = r2.zw / float2(9.99999975e-05, 9.99999975e-05);
